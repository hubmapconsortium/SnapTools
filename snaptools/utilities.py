...
def checkFileFormat(fname):
    ...
    if (
        fname.endswith(".bed")
        or fname.endswith(".bed.gz")
        or fname.endswith(".bed.bz2")
    ):
        if is_bed(fname):
            return "bed"
        ...
        fname.endswith(".gtf.gz")
        or fname.endswith(".gtf")
        or fname.endswith(".gff")
        or fname.endswith(".gff.gz")
    ):
        if is_gff(fname):
            return "gtf"
    else:
